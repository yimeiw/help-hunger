        ...
        <div class="w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0 mt-6">
            <main class="flex flex-col w-auto">
                ...
                <div class="flex justify-center items-center lg:w-auto">
                    <a href="{{ route('donatur.donations.show') }}" class="flex justify-center items-center font-bold text-redb text-lg bg-creamcard border-redb border-2 rounded-xl w-56 h-auto p-2 hover:text-greenbg hover:border-greenbg transition duration-300 ease-in-out">
                        Start Donate
                    </a>
                </div>
