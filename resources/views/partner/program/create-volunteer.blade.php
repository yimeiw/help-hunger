<x-auth-layout>
    ...
    <div class="flex justify-between items-center">
        <a href="{{ route('partner.program.show', ['type' => 'volunteer']) }}" class="flex justify-end m-6">
    ...
    <x-authentication-card>
        ...
        <form action="{{ route('partner.program.volunteer.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4">
                <x-label for="event_description" value="Description" class="mb-1" />
                <textarea id="event_description" name="event_description" rows="4" class="w-full text-xs text-blackAuth [box-shadow:4px_5px_0px_rgb(144,43,41,1)] focus:outline-none focus:ring-2 focus:ring-redb textarea:text-greyAuth textarea:text-xs bg-creamcard rounded-lg">{{ old('event_description') }}</textarea>
            ...
            <div class="mb-4">
                ...
                <x-input-error :messages="$errors->get('current_needs')" class="mt-2" />
            </div>
            ...
            <div class="mb-4">
                ...
                <x-input id="location_zipcode" type="text" name="location_zipcode" class="block w-full mt-1" :value="old('location_zipcode')" required />
...
@push('scripts')
    <script>
        ...
        function resetFormsAndNavigate(event) {
            ...
            window.location.href = "{{ route('partner.program.show', ['type' => 'volunteer']) }}";
        }
        ...
        // --- Partner Dropdown Script (assuming this is separate) ---
        // If you have a partner dropdown, ensure this script is for it.
