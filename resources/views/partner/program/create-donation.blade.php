<x-auth-layout>
    ...
    <div class="flex justify-between items-center">
        <a href="{{ route('partner.program.show', ['type' => 'donation']) }}" class="flex justify-end m-6">
    ...
    <x-authentication-card>
        ...
        <form action="{{ route('partner.program.donation.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
