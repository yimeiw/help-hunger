    ...
    <x-authentication-card>
        ...
        <form action="{{ route('admin.manage.event.volunteer.add') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea id="description" name="event_description" rows="4" class="w-full text-xs [box-shadow:4px_5px_0px_rgb(144,43,41,1)] focus:outline-none focus:ring-2 focus:ring-redb textarea:text-greyAuth textarea:text-xs bg-creamcard rounded-lg">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <x-input id="current_needs" type="number" name="current_needs" class="block w-full mt-1" :value="old('current_needs')" />
            </div>

            <div class="mb-4">
                <x-label for="max_volunteers" value="Max Volunteers" />
                <x-input id="max_volunteers" type="number" name="max_volunteers" class="block w-full mt-1" :value="old('max_volunteers')" min="1" />
            </div>
