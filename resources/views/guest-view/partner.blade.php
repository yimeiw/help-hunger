<x-guest-layout>
    ...
    <body class="text-redb scroll-smooth">
        <p class="font-bold text-3xl text-center mt-12 mb-4 px-96">
            OUR PARTNER
        </p>
        <p class="font-regular text-lg text-center mb-10 px-72">
        ...
        <div id="community" class="m-10">
            <p class="text-3xl font-bold mb-2">Community Partner</p>
            <p class="text-lg font-regular mb-10">Local communities play a vital role in reaching areas and groups most in need. HelpHunger collaborates with various communities to coordinate food distribution, organize public kitchens, and raise awareness about the importance of sharing. Together with communities, we build grassroots solidarity.</p>
        ...
        <div id="ngo" class="m-10">
            <p class="text-3xl font-bold mb-2 text-right">NGO Partner</p>
            <p class="text-lg font-regular text-right mb-10">Non-profit organizations are strategic allies in our mission. HelpHunger partners with NGOs working in food, humanitarian, and social sectors to expand the reach of aid, strengthen distribution systems, and develop sustainable, high-impact programs.</p>
            <div class="flex flex-row justify-center items-center gap-12 bg-greenbg p-8 rounded-lg h-72">
                @foreach($partners as $partner)
                    @if ($partner->type === 'ngo')
                        <a target="_blank" rel="noopener noreferrer" href="{{ $partner->partner_link }}" class="group relative flex flex-col items-center justify-center bg-creamcard p-6 h-full w-40 rounded-lg shadow-quadrupleNonHover hover:shadow-quadrupleHover hover:text-greenbg transition duration-300 ease-in-out">
        ...
        <div id="orphanage" class="m-10">
            <p class="text-3xl font-bold mb-2">Orphanage Partner</p>
            <p class="text-lg font-regular mb-10">Local communities play a vital role in reaching areas and groups most in need. HelpHunger collaborates with various communities to coordinate food distribution, organize public kitchens, and raise awareness about the importance of sharing. Together with communities, we build grassroots solidarity.</p>
            <div class="flex flex-row justify-center items-center gap-12 bg-greenbg p-8 rounded-lg h-72">
                @foreach($partners as $partner)
