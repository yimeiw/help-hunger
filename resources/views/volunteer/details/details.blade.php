                            ...
                            <p class="text-sm">Status:
                                @if ($volunteerParticipationStatus)
                                    @if($volunteerParticipationStatus == 'pending')
                                        <span class="text-yellow-500 font-bold text-sm">{{ ucfirst($volunteerParticipationStatus) }}</span>
                                    @elseif($volunteerParticipationStatus == 'accepted')
                                        <span class="text-green-500 font-bold text-sm">{{ ucfirst($volunteerParticipationStatus) }}</span>
                                    @elseif($volunteerParticipationStatus == 'rejected')
                                        <span class="text-red-500 font-bold text-sm">{{ ucfirst($volunteerParticipationStatus) }}</span>
                                    @else
